    ...
    <div class="">
      ...
      <div class="col-sm-12 col-md-12 col-lg-6 col1"><br>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control bg-dark text-light" id="port1" placeholder="name@example.com">
            </div>
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label text-white">Website Url</label>
                <input type="text" class="form-control bg-dark text-light" id="port2" placeholder="nameofwebsite000.com">
            </div>
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label text-white">Kind of system</label>
                <input type="text" class="form-control bg-dark text-light" id="port3" placeholder="Ex: Webshop Ecommerce, Online Registraion...">
            </div>
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label text-white">Select Section</label>
                <select class="form-select form-select-lg bg-dark text-light mb-3" aria-label=".form-select-lg example">
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control bg-dark text-light" id="port4" placeholder="Text..." rows="3"></textarea>
            </div>
      ...
      <div class="col-sm-12 col-md-12 col-lg-12">
        <br>
        <div class="progress" >
          <div class="progress-bar progress-bar-striped bg-success" role="progressbar" style="width: 0%" aria-valuenow="" aria-valuemin="0" aria-valuemax="100">0%</div>
        </div>
